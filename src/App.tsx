...
const translations = {
  cat: {
    ...
    about: {
      medIdentitat: { subtitulo: 'IDENTITAT MEDITERRÀNIA', texto: 'MiRA neix entre la llum clara del Maresme i el ritme pausat de la costa. Una firma de moda digital, local i conscient que dissenya peces per vestir amb seguretat, calma i presència, sense renunciar a la precisió tecnològica.' },
      ...
      medLookbook: { titulo: 'Explora la dualitat de la nostra col·lecció', btn: 'VEURE LA COL·LECCIÓ' },
    },
  ...
  esp: {
    ...
    about: { identity: 'IDENTIDAD MEDITERRÁNEA', born: 'BORN IN THE MARESME', intro: 'MiRA nace entre la luz clara del Maresme y el ritmo pausado de la costa. Una firma de moda digital, local y consciente que diseña prendas para vestir con seguridad, calma y presencia, sin renunciar a la precisión tecnológica.', missionEyebrow: 'MISIÓN Y VISIÓN', missionTitle: 'Comprar online con la confianza de una prenda hecha para ti.', missionText: 'Nuestra misión es eliminar la duda de la talla y acercar la moda responsable a una experiencia digital más humana, precisa y transparente.', visionText: 'Aspiramos a convertir MiRA en el e-commerce de referencia para una nueva generación de consumidoras: mujeres que buscan diseño local, tecnología útil y un armario más pequeño, pero mejor pensado.', valuesEyebrow: 'VALORES', valuesTitle: 'Diseño que respira, tecnología que acompaña.', valueInnovation: 'Innovación accesible', valueInnovationText: 'La realidad aumentada y los patrones 3D se ponen al servicio de una compra clara, intuitiva y sin barreras.', valueTransparency: 'Transparencia', valueTransparencyText: 'Materiales, origen, precios y procesos explicados con honestidad para que cada decisión tenga contexto.', valueSustainability: 'Sostenibilidad real', valueSustainabilityText: 'Producción local, lotes limitados y residuo cero para evitar sobrestock y alargar el valor de cada prenda.', digitalEyebrow: 'INNOVACIÓN DIGITAL', digitalTitle: 'El probador AR como nueva forma de confianza.', digitalText: 'MiRA combina patrones digitales, recomendación de talla y realidad aumentada para que puedas ver cómo se adapta cada prenda antes de comprar. Una experiencia técnica, pero diseñada para sentirse natural.', lookbook: 'Lookbook MiRA', lookbookTitle: 'Explora la dualidad de nuestra colección', altBeach: 'Playa del Maresme, origen de MiRA', altLifestyle: 'Estilo de vida MiRA en el Maresme', altFabric: 'Textura de tejido MiRA', altModels: 'Dos modelos MiRA con prendas de la colección', altCapsule: 'Armario cápsula y selección consciente MiRA', altDesign: 'Diseño técnico digital y patrones 3D MiRA', altLookbook: 'Lookbook MiRA con dos modelos' },
